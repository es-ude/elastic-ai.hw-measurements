...
from elasticai.fpga_testing.runner.signal_generator import generate_sinusoidal_waveform
...
class ExperimentEcho(ExperimentMain):
    ...
    def __init__(self, device_id: int) -> None:
        ...
        self.__data_scaling_value = 2 ** (
            self._device.get_bitwidth_data - self.__settings_echo.bitwidth_data
        )
    ...
    def postprocess_data(self) -> np.ndarray:
        ...
        data_return = self._device.slice_data_from_transmission(
            data=self._buffer_data_get, is_signed=self.__settings_echo.signed_data, stepsize=2
        )
