cocotb_settings_dev = dict(
    src_files=[
        ...
        "01_rom/skeleton_rom.v",
        "01_rom/waveform_lut0.v",
        "02_bram/skeleton_ram.v",
        "02_bram/bram_single.v",
        "03_mult/skeleton_math.v",
        "03_mult/mult_lut_signed.v",
        "03_mult/adder_full.v",
        "03_mult/adder_half.v",
        "04_actfunc/skeleton_math.v",
        "04_actfunc/hardtanh.v",
    ],
    path2src=".",
