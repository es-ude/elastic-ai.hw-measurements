...
def test_led_templates() -> None:
    cocotb_settings = deepcopy(cocotb_settings_arty7)
    cocotb_settings["cocotb_test_module"] = "elasticai.fpga_testing.tests.arty7_led_test"
    run_cocotb_sim_for_src_dir(**cocotb_settings)


@pytest.mark.simulation
def test_led_build() -> None:
    artefact_dir = get_path_to_project() / "temp_build" / "arty7_led"
