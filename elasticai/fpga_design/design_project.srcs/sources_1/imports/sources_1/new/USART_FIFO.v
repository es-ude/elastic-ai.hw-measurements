...
// Design Name: 
// Module Name:     USART_FIFO
// Project Name: 
// Target Devices:  FIFO UART-Buffer for RX-Processing 
// Tool Versions: 
// Description:     Processing of LSB first for different fifo sizes
// 
// Dependencies:    MODE_RAM = 0:   Fixed internal array
//                  MODE_RAM = 1:   External data (non-sliced)
// 
// TODO:            Adding BRAM for uart_fifo
//////////////////////////////////////////////////////////////////////////////////

module USART_FIFO#(parameter FIFO_SIZE = 'd4)(
    input wire CLK,
    input wire nRST,
