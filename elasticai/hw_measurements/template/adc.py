...
class TestHandlerADC:
    ...
    def __init__(
        ...
        if not self._en_debug and not only_plot:
            ...
            self._hndl_daq.serial_open_known_target(resource_name=com_sets.com_ngu, do_reset=True)
    ...
    def run_transfer_test(self) -> dict:
        ...
        results = self._hndl_test.run_test_transfer(
            ...
            func_sens=self._hndl_daq.get_measurement_voltage
...
def run_test() -> None:
    ...
    hndl = TestHandlerADC(com_dut="COM7", en_debug=False, only_plot=bool_only_plot)
